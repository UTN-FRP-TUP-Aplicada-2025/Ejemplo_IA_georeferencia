...
start "GeoFoto.Api" cmd /k "title GeoFoto.Api && cd /d %~dp0..\src\GeoFoto.Api && set ASPNETCORE_ENVIRONMENT=Development && dotnet run --configuration Debug --urls http://0.0.0.0:%API_PORT%"
...
:: Lanzar Web
start "GeoFoto.Web" cmd /k "title GeoFoto.Web && cd /d %~dp0..\src\GeoFoto.Web && set ASPNETCORE_ENVIRONMENT=Development && dotnet run --configuration Debug --urls http://localhost:%WEB_PORT%"
