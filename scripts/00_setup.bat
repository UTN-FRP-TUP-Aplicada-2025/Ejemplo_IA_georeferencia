...
if not exist "src\GeoFoto.Api\wwwroot\uploads" (
    mkdir "src\GeoFoto.Api\wwwroot\uploads"
...
if errorlevel 1 (
    ...
    dotnet ef migrations add InitialCreate --project src\GeoFoto.Api\GeoFoto.Api.csproj
    dotnet ef database update --project src\GeoFoto.Api\GeoFoto.Api.csproj
